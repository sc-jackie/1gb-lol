...
export const KEEP_PHOTOS = {
  ...
  coolpix: {
    src: "/photos/nikon-coolpix-3200.jpg",
  ...
  fz20: {
    src: "/photos/panasonic-lumix-fz20.jpg",
  ...
  fz20Slot: {
    src: "/photos/panasonic-lumix-fz20-sd-slot.jpg",
